...
namespace Jardam.Areas.Identity.Pages.Account.Manage
{
    public partial class EmailModel : PageModel
    {
        ...
        public class InputModel
        {
            [Required]
            [EmailAddress]
            [Display(Name = "Новый адрес почты")]
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    ...
                    $"Пожалуйста, подтвердите вашу почту <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>кликнув сюда</a>.");

                StatusMessage = "Письмо с подтверждением отправлено. Пожалуйста, проверьте вашу почту.";
                return RedirectToPage();
            }

            StatusMessage = "Ваша почта не изменена.";
            return RedirectToPage();
        }
